        ...
        <div class="row full-height justify-content-center">
            <div class="col-12 text-center align-self-center py-5">
                <div class="section pb-5 pt-5 pt-sm-2 text-center">
                    <h6 class="mb-0 pb-3"><span>Sortie enfant</span></h6>
                    <div class="card-3d-wrap mx-auto">
                        <div class="card-3d-wrapper">
                            <div class="card-front">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        <form action="/departureSave" method="POST" onsubmit="return confirm('Est ce bien votre enfant ?');">
                                            <div class="form-group">
                                                ...
                                                <p></p>
                                                <p ALIGN="left" class="form-style">Arrivée: {{ $dateEntry }}</p>                                                
                                                <input class="form-style" type="datetime-local" name="date" step="1" value={{ $date}}>                                         
                                            </div>
